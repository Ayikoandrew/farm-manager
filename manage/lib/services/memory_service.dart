...
class MemoryService {
  ...
  /// Ensure a container exists for the user by adding a system memory
  /// This creates the container if it doesn't exist (via the auto-create RPC)
  /// Returns true if successful, false otherwise
  Future<bool> ensureContainerExists(String containerTag) async {
    try {
      // Add a system initialization memory - this triggers container creation
